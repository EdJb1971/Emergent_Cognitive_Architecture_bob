...
class Settings(BaseSettings):
    ...
    PREDICTIVE_PERCEPTION_ENABLED: bool = Field(
        True, env="PREDICTIVE_PERCEPTION_ENABLED"
    )
    PREDICTIVE_PERCEPTION_SHADOW_MODE: bool = Field(
        True, env="PREDICTIVE_PERCEPTION_SHADOW_MODE"
    )
    PREDICTIVE_PERCEPTION_MAX_PRIOR_CYCLES: int = Field(
        3, ge=0, le=20, env="PREDICTIVE_PERCEPTION_MAX_PRIOR_CYCLES"
    )
    PREDICTIVE_PERCEPTION_MAX_HYPOTHESES: int = Field(
        8, ge=0, le=32, env="PREDICTIVE_PERCEPTION_MAX_HYPOTHESES"
    )
    PREDICTIVE_PERCEPTION_MIN_OBSERVATION_RELIABILITY: float = Field(
        0.55,
        ge=0.0,
        le=1.0,
        env="PREDICTIVE_PERCEPTION_MIN_OBSERVATION_RELIABILITY",
    )
    PREDICTIVE_PERCEPTION_CLARIFICATION_THRESHOLD: float = Field(
        0.50,
        ge=0.0,
        le=1.0,
